package com.core.upgrade.entity;
...
import com.core.upgrade.Activity.TranslucentActivity;
import com.core.upgrade.service.VersionUpdateService;
import com.core.upgrade.utils.MD5Util;
...
public class VersionUpdateConfig {
    ...
    public VersionUpdateConfig setLength(int length) {
        if (fileBean == null) {
            throw new NullPointerException("url cannot be null, you must call setDownLoadURL() before setNewVersion().");
        }
