package com.core.upgrade.service;
...
import com.core.upgrade.R;
import com.core.upgrade.download.DownloadTask;
import com.core.upgrade.download.InitThread;
...
public class VersionUpdateService extends Service {
    ...
    private void installPage(FileBean filebean) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Log.d("installPage", "installPage: " + getPackageName());
